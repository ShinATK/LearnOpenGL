...
glm::mat4 myLookAT(glm::vec3 position, glm::vec3 target, glm::vec3 upper);
...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("../shaders/vs.hlsl", "../shaders/fs.hlsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 view = myLookAT(cameraPos, cameraPos + cameraFront, cameraUp);
...
glm::mat4 myLookAT(glm::vec3 position, glm::vec3 target, glm::vec3 upper)
{
    ...
    right = glm::normalize(glm::cross(upper, direction));
    up = glm::cross(direction, right);

    glm::mat4 translation = glm::mat4(1.0f);
    translation[3][0] = -position.x; // First column, first row
