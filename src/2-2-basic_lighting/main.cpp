...
int main()
{
    ...
    // TODO：着色器、编译、链接
    Shader cubeShader(
        relativePath(FILE_FOLDER_PATH, "shader/2-2-cube_vertex.glsl"), 
        relativePath(FILE_FOLDER_PATH, "shader/2-2-cube_frag.glsl"));
    Shader lightShader(
        relativePath(FILE_FOLDER_PATH, "shader/2-2-light_vertex.glsl"), 
        relativePath(FILE_FOLDER_PATH, "shader/2-2-light_frag.glsl"));
