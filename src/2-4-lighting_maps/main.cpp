...
int main()
{
    ...
    // TODO：着色器、编译、链接
    Shader cubeShader(
        relativePath(FILE_FOLDER_PATH, "shader/2-4-cube_vertex.glsl"), 
        relativePath(FILE_FOLDER_PATH, "shader/2-4-cube_frag.glsl"));
    Shader lightShader(
        relativePath(FILE_FOLDER_PATH, "shader/2-4-light_vertex.glsl"), 
        relativePath(FILE_FOLDER_PATH, "shader/2-4-light_frag.glsl"));
    ...
    unsigned int diffuseMap = loadTexture(relativePath(FILE_FOLDER_PATH, "texture/container2.png"));
    unsigned int specularMap = loadTexture(relativePath(FILE_FOLDER_PATH, "texture/container2_specular.png"));
    unsigned int emissionMap = loadTexture(relativePath(FILE_FOLDER_PATH, "texture/matrix.jpg"));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        cubeShader.setFloat("dynamic_texcoord", (float)glfwGetTime());
        ...
        static float diffuse = 0.5f;
        static float specular = 1.0f;
        cubeShader.setVec3("light.ambient", lightColor * glm::vec3(ambient));
        cubeShader.setVec3("light.diffuse", lightColor * glm::vec3(diffuse));
        cubeShader.setVec3("light.specular", lightColor * glm::vec3(specular));
