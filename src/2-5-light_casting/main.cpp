...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        cubeShader.setFloat("light.CutOff", glm::cos(glm::radians(12.5f)));         // 内切光角
        cubeShader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));    // 外切光角
        ...
        cubeShader.setFloat("light.constant", 1.0f);                // 设置光照衰减：常数项
        cubeShader.setFloat("light.linear", 0.045f);                 // 设置光照衰减：一次项
        cubeShader.setFloat("light.quadratic", 0.0075f);             // 设置光照衰减：二次项
