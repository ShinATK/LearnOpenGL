...
int main()
{
    myWindow.window_Init(800, 600, "4-3-blend_testing");
    ...
    Shader shader(
        relativePath(FILE_FOLDER_PATH, "shader/4-3-vertex.glsl"), 
        relativePath(FILE_FOLDER_PATH, "shader/4-3-frag.glsl"));
    ...
    unsigned int grassTexture = loadTexture(relativePath(FILE_FOLDER_PATH, "texture/blending_transparent_window.png"));
    ...
    while (!glfwWindowShouldClose(myWindow.window))
    {
        ...
        // sort the glass by the distance to the camera Position
